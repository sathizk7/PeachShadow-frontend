...
// Login to the real backend auth endpoint (local backend mounted at /v1/auth)
export const postBackendLogin = (data: any) => api.create(url.POST_BACKEND_LOGIN, data);

// Logout from the real backend auth endpoint (local backend mounted at /v1/auth/logout)
export const postBackendLogout = (data: any) => api.create(url.POST_BACKEND_LOGOUT, data);
