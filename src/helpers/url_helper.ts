...
// Backend auth (mounted under /v1/auth in the auth service)
export const POST_BACKEND_LOGIN = "/v1/auth/login";
// Backend auth (mounted under /v1/auth/logout in the auth service)
export const POST_BACKEND_LOGOUT = "/v1/auth/logout";
