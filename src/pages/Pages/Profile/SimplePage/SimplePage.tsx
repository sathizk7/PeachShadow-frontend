                                                        ...
                                                        <div className="d-flex flex-wrap gap-2">
                                                            <div>
                                                                <Link to="#" className="avatar-xs d-block">
                                                                    <span
                                                                        className="avatar-title rounded-circle fs-16 bg-dark text-body material-shadow">
                                                                                        ...
                                                                                        <Link to="#" className="accordion-button p-2 shadow-none" id="collapseFour" >
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                                    className="flex-shrink-0 avatar-xs">
                                                                                                    <div
                                                                                                        className="avatar-title bg-light text-muted rounded-circle material-shadow">
                                                                                                        <i
                                                                                            ...
                                                                                            <div className="avatar-group">
                                                                                                ...
                                                                                                <Link to="#"
                                                                                                    ...
                                                                                                    <div
                                                                                                        className="avatar-xs">
                                                                                                        <div
                                                                                                            className="avatar-title rounded-circle material-shadow">
                                                                                                            2+
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </Link>
                                                                                        ...
                                                                                        <Link className="accordion-button p-2 shadow-none"
                                                                                            ...
                                                                                            <div className="d-flex">
                                                                                                <div className="avatar-xs">
                                                                                                    <div
                                                                                                        className="avatar-title rounded-circle bg-light text-danger material-shadow">
                                                                                                        <i
                                                                                            ...
                                                                                            <Row className="mt-2">
                                                                                                <Col xxl={6}>
                                                                                                    <Row
                                                                                                        ...
                                                                                                        <Col xs={3}>
                                                                                                            <img src={smallImage3} alt="" className="img-fluid rounded material-shadow" />
                                                                                                        </Col>

                                                                                                        <Col xs={3}>
                                                                                                            <img src={smallImage5} alt="" className="img-fluid rounded material-shadow" />
                                                                                                        </Col>

                                                                                                        <Col xs={3}>
                                                                                                            <img src={smallImage7} alt="" className="img-fluid rounded material-shadow" />
                                                                                                        </Col>

                                                                                                        <Col xs={3}>
                                                                                                            <img src={smallImage9} alt="" className="img-fluid rounded material-shadow" />
                                                                                                        </Col>
                                                    ...
                                                    <CardBody>
                                                        ...
                                                        >
                                                            ...
                                                            <div className="swiper-wrapper">
                                                                <SwiperSlide>
                                                                    <Card
                                                                        className="profile-project-card shadow-none profile-project-success mb-0 material-shadow">
                                                                ...
                                                                <SwiperSlide>
                                                                    <Card
                                                                        className="profile-project-card shadow-none profile-project-info mb-0 material-shadow">
                                                                        <CardBody className="p-4">
                                                                            <div className="d-flex">
                                                                                <div
                                                                                    className="flex-grow-1 text-muted overflow-hidden">
                                                                ...
                                                                <SwiperSlide>
                                                                    <Card
                                                                        className="profile-project-card shadow-none profile-project-danger mb-0 material-shadow">
                                                                        <CardBody className="p-4">
                                                                            <div className="d-flex">
                                                                                <div
                                                                                    className="flex-grow-1 text-muted overflow-hidden">
                                                ...
                                                <div className="acitivity-timeline">
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        <div className="flex-shrink-0 avatar-xs acitivity-avatar">
                                                            <div className="avatar-title bg-success-subtle text-success rounded-circle material-shadow"> N </div>
                                                        </div>
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <Row >
                                                                <Col xxl={4}>
                                                                    <div className="row border border-dashed gx-2 p-2 mb-2">
                                                                        <div className="col-4">
                                                                            <img src={smallImage2}
                                                                                alt="" className="img-fluid rounded material-shadow" />
                                                                        </div>
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        <div className="flex-shrink-0">
                                                            <div className="avatar-xs acitivity-avatar">
                                                                <div
                                                                    className="avatar-title rounded-circle bg-info-subtle text-info material-shadow">
                                                ...
                                                <Row>
                                                    {(projects || []).map((item, key) => (
                                                        <Col xxl={3} sm={6} key={key}>
                                                            <Card className={`profile-project-card shadow-none material-shadow profile-project-${item.cardBorderColor}`}>
                                                                <CardBody className="p-4">
                                                                    <div className="d-flex">
                                                                        <div className="flex-grow-1 text-muted overflow-hidden">
