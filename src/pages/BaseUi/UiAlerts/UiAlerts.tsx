                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <h6>Danger Alert</h6>
                                                <Alert color="danger" className='border-0 border-0 material-shadow mb-xl-0'>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <h6>Danger Alert</h6>
                                                <Alert color="danger" className="material-shadow mb-xl-0">
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert color="danger" className="border-2 bg-body-secondary alert-dismissible border-2 bg-body-secondary fade show mb-xl-0 material-shadow">
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <h6>Dark Alert</h6>
                                                <UncontrolledAlert color="dark" className="border-2 bg-body-secondary alert-dismissible border-2 bg-body-secondary fade show mb-0 material-shadow">
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <h6>Danger Alert</h6>
                                                <UncontrolledAlert color="danger" className="alert-solid alert-dismissible bg-danger text-white alert-label-icon fade show mb-xl-0 material-shadow" closeClassName="btn-close-white">
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <h6>Dark Alert</h6>
                                                <UncontrolledAlert color="dark" className="alert-solid alert-dismissible bg-dark text-white alert-label-icon fade show mb-0 material-shadow" closeClassName="btn-close-white">
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <h6>Danger Alert</h6>
                                                <UncontrolledAlert color="danger" className="alert-top-border mb-xl-0 material-shadow">
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <h6>Dark Alert</h6>
                                                <UncontrolledAlert color="dark" className="alert-top-border mb-0 material-shadow">
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <h6>Danger Alert</h6>
                                                <UncontrolledAlert color="danger" className="alert-label-icon label-arrow mb-xl-0 material-shadow">
                                                    <i className="ri-error-warning-line label-icon"></i><strong>Danger</strong>
                                                    - Label
                                                    icon arrow alert
                                                </UncontrolledAlert>
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <h6>Dark Alert</h6>
                                                <UncontrolledAlert color="dark" className="alert-label-icon label-arrow mb-0 material-shadow">
                                                    <i className="ri-refresh-line label-icon"></i><strong>Dark</strong>
                                                    - Label icon arrow alert
                                                </UncontrolledAlert>
