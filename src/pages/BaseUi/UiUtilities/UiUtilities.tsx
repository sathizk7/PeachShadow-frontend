                                        ...
                                        <div>
                                            <div>
                                                <div className="d-flex align-items-start flex-wrap gap-4">
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md  material-shadow rounded" alt="rounded" />
                                                        <p><code>.rounded</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md  material-shadow rounded-top" alt="rounded-top" />
                                                        <p><code>.rounded-top</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md  material-shadow rounded-end" alt="rounded-end" />
                                                        <p><code>.rounded-end</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md  material-shadow rounded-bottom" alt="rounded-bottom" />
                                                        <p><code>.rounded-bottom</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md  material-shadow rounded-start" alt="rounded-start" />
                                                        <p><code>.rounded-start</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md  material-shadow rounded-circle" alt="rounded-circle" />
                                                    ...
                                                    <div className="text-center">
                                                        <img src={img2}
                                                            className="avatar-md  material-shadow w-auto rounded-pill" alt="rounded-pill" />
                                            ...
                                            <div>
                                                ...
                                                <div className="d-flex align-items-start flex-wrap gap-4">
                                                    <div className="text-center">
                                                        <img src={avatar1}
                                                            className="avatar-md material-shadow rounded-0" alt="rounded-0" />
                                                        <p><code>.rounded-0</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1}
                                                            className="avatar-md material-shadow rounded-1" alt="rounded-1" />
                                                        <p><code>.rounded-1</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1}
                                                            className="avatar-md material-shadow rounded-2" alt="rounded-2" />
                                                        <p><code>.rounded-2</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1}
                                                            className="avatar-md material-shadow rounded-3" alt="rounded-3" />
                                                        <p><code>.rounded-3</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1} className="avatar-md material-shadow rounded-4" alt="rounded-4" />
                                                        <p><code>.rounded-4</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1} className="avatar-md material-shadow rounded-5" alt="rounded-5" />
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <div className="mt-5">
                                            ...
                                            <div className="vstack gap-2 col-md-5 mx-auto">
                                                ...
                                                <Button color="secondary" className='material-shadow' outline>Cancel</Button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div className="hstack gap-3 mt-3">
                                                ...
                                                <div className="bg-light material-shadow border p-1 px-2 ms-auto">Third item</div>
                                            </div>
                                        </div>
