                    ...
                    <Card className="card-height-100">
                        <CardHeader className="align-items-center d-flex">
                            ...
                            <div className="flex-shrink-0">
                                <Button color="primary" size='sm' className="btn-soft-primary material-shadow">
                                    Export Report
                                </Button>
                            </div>
                        </CardHeader>
                ...
                <Col xxl={4} xl={6}>
                    <Card className="card-height-100">
                        <CardHeader className="align-items-center d-flex">
                            ...
                            <div>
                                <Button color="secondary" size="sm" className="material-shadow-none btn-soft-secondary me-1">
                                    ALL
                                </Button>
                                <Button color="primary" size="sm" className="material-shadow-none btn-soft-primary me-1">
                                    1M
                                </Button>
                                <Button color="secondary" size="sm" className="material-shadow-none btn-soft-secondary">
                                    6M
                                </Button>
                            </div>
                        </CardHeader>
                    ...
                    <Card className="card-height-100">
                        <CardHeader className="border-0 align-items-center d-flex">
                            ...
                            <div>
                                ...
                                <Button color="primary" size="sm" className="material-shadow-none btn-soft-primary">
                                    1Y
                                </Button>
                            </div>
                        </CardHeader>
                ...
                <Col xxl={4} xl={6}>
                    <Card className="card-height-100">
                        <CardHeader className="align-items-center d-flex">
                            ...
                            <div className="flex-shrink-0">
                                <Button color="primary" size="sm" className="btn-soft-primary material-shadow-none">
                                    Export Report
                                </Button>
                            </div>
                        </CardHeader>
