                ...
                <Card className="card-height-100">
                        ...
                        <div className="flex-shrink-0">
                            <UncontrolledDropdown className="card-header-dropdown">
                                <DropdownToggle tag="a" className="text-reset dropdown-btn" role="button">
                                    <span className="fw-semibold text-uppercase fs-12">Sort by: </span><span className="text-muted">{seletedMonth.charAt(0).toUpperCase() + seletedMonth.slice(1)}
                    ...
                    <div className="card-body p-0">
                        <div>
                            ...
                            series={chartData} 
                            chartId="audiences-sessions-country-charts"
                             />
                        </div>
                    </div>
                </Card>
