                                    ...
                                    <div className="live-preview">
                                        <div>
                                            ...
                                            <Row className="g-3">
                                                ...
                                                <Col lg={12}>
                                                    <UncontrolledDropdown className="input-group">
                                                        <DropdownToggle tag="button" className="btn btn-outline-secondary dropdown-toggle material-shadow-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</DropdownToggle>
                                                        <DropdownMenu>
